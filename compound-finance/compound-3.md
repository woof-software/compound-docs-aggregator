...
deployments:
  Unichain - USDC Base:
    ...
    contracts:
      ...
      cUSDCv3 Implementation: '0xfa893A2E91e36689ca5c83d24ff4dD89702384f5'
      ...
      UNI:
        ...
        Supply Cap: '4.31K'
        Supply Cap Raw: '4307000000000000000000'
  ...
  Unichain - WETH Base:
    ...
    contracts:
      ...
      cWETHv3 Implementation: '0xb89bD355e4F502281Daa516d43bBA1644029Ce03'
      ...
      wstETH:
        ...
        Supply Cap: '5.00K'
        Supply Cap Raw: '5000000000000000000000'
        Price Feed: '0x73D3e8b769bC687AeEc487AAeFCAd31F4d9F84A7'
      weETH:
        ...
        Supply Cap: '952'
        Supply Cap Raw: '952000000000000000000'
  ...
  Ronin - WRON Base:
    ...
    contracts:
      ...
      cWRONv3 Implementation: '0x9505CDf04E2aCb266a3B66910C8B827269cd7f3D'
      ...
      USDC:
        ...
        Supply Cap: '0'
        Supply Cap Raw: '0'
        Price Feed: '0x62623C1374D12F946a9CA8597a137BbfBE015665'
      AXS:
        address: '0x97a9107C1793BC407d6F527b77e7fff4D812bece'
        Borrow CF: '50.0%'
        Borrow CF Raw: '500000000000000000'
...
<br />
> **Note:** The deployment data shown below is sourced from the [compound-docs-aggregator](https://github.com/woof-software/compound-docs-aggregator){:target="_blank"} repository. Data collected on: **2026-06-02 14:19:15.926 UTC**.
